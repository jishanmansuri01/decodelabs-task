...
All routes were manually tested in Postman — see [`Task-2-Backend/API_TESTING.md`](./Task-2-Backend/API_TESTING.md) for screenshots and explanations of each test.
